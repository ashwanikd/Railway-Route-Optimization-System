<?php
	...
	}else die("login first");
	$name = '<a href="login.php"><h3 class="display-5" style="color: white;font-weight: bold;text-decoration: underline;">USER LOGIN<h3></a>';
?>
	...
	<body>
		...
		<div class="row" style="margin-left: 2px;">
			...
			<div class="col-9" id="form_division" >
                <h3 style="color: white;font-weight: bold;">Enter Payment Details:<h3>
                <hr style="border-color: white;border-width: 3px;">
				<form method="post" action="confirmbooking1.php">
					<label style="color: white;">Debit Card No:</label>
					<input type="text" class="form-control"></input>
					<label style="color: white;">Name:</label>
					<input type="text" class="form-control"></input>
					<label style="color: white;">Expire:</label>
