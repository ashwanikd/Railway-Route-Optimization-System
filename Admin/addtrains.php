	...
	<body>
		...
		<div class="row" style="margin-left: 2px;">
			...
			<div class="col-9" id="form_division" >
                <h3 style="color: white;font-weight: bold;">Add Station<h3>
                <hr style="border-color: white;border-width: 3px;">
				<Form class="form" action="trainadd.php" method="post">
					<label style="color: white;">Train_ID</label>
                    <input type="text" name="train_id" value="<?php echo $max+1;?>" disabled />
                    <label style="color: white;">Train Name</label>
                    <input type="text" name="train_name" />
                    <label style="color: white;">Route ID</label>
