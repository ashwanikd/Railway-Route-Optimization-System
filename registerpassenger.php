	...
	<body>
		...
		<div class="row" style="margin-left: 2px;">
			...
			<div class="col-9" id="form_division" >
					<center><div id="form_division" style=" width: 70%;">
						<form method="post" class="form" action="register.php" style="text-align: left;">
							<p style="color: white;font-size: 16px;">
                                Username:<br><input type="text" name="username" style="color: gray;"/><br>
                                Password:<br><input type="password" name="password" style="color: gray;"/><br>
                                Name:<br><input type="text" name="name" style="color: gray;"/><br>
                                Date of Birth:<br><input type="date" name="dob" style="color: gray;"/><br>
                                Mobile:<br><input type="text" name="mobile" style="color: gray;"/><br>
                                Address:<br><input type="text" name="address" style="color: gray;"/><br>
                                <input class="btn" type="submit" value="REGISTER" style="color: white;font-size: 23px;"/>		
							</p>
				</form>
			</div></center>
		</div>
