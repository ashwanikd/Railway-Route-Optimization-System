<?php
    ...
    require("DataLoadingFiles/loadgraph.php");
    session_start();
    $name = "";
    ...
    $dijkstra->findShortestPath($src,$des);
    $result = $dijkstra->getPath();
?>
<html>
	<head>
	...
	<body>
		...
		<div class="row" style="margin-left: 2px;">
			...
			<div class="col-9 container" id="form_division" >
				<h3 style="color: white;font-weight: bold;">No Trains Found Between Given Pair of Stations<h3>
                <hr style="border-color: white;border-width: 3px;">
                <?php
                    echo "<h3 style=\"color: white;font-weight: bold;\">Shortest Path Found<h3>";
